...
const Credits = () => {
  ...
  const purchasePlan = async (planId) => {  // ✅ FIX: corrected function name
    try {
          ...
          plans.map((plan) => (
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-2xl font-bold text-purple-600 dark:text-purple mb-4">
                  {plan.price}
